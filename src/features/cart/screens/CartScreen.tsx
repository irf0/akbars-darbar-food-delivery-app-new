        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            {items.length < 1 ?
                <View style={{ justifyContent: "center", alignSelf: "center", marginTop: "50%" }}>
                    <Text>
                        Uh! Oh You don't have anything in the Cart yet.
                    </Text>
                    <TouchableOpacity style={{ backgroundColor: "red", padding: 15, }} activeOpacity={0.7}
                        ...
                        renderItem={({ item }) => (
                            <View style={styles.cartRow}>
                                ...
                                <View style={styles.rightContent}>
                                    ...
                                    <Pressable
                                        onPress={() => setActiveItem({ id: item.id, portion: item.portion, name: item.name })}
