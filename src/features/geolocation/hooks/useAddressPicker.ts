...
import { checkLocationPermission, getCurrentCoords, requestLocation, reverseGeocode } from '@utils/permissions/expopermissions';
...
export const useAddressPicker = () => {
    ...
    const handleConfirmPress = async () => {
        try {
            ...
            const result = checkServiceabilityClient( //TODO:replace this block with server result.
                latitude,
                longitude,
