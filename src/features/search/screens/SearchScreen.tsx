        ...
        <View style={styles.titleRow}>
          <View
            style={[
              styles.dietDot,
              {
                borderColor: item.item_type === 'Veg' ? VEG_GREEN : NON_VEG_RED,
              },
            ]}>
            <View
              style={[
                styles.dietDotInner,
                {
                  backgroundColor: item.item_type === 'Veg' ? VEG_GREEN : NON_VEG_RED,
                },
              ]}
            />
          </View>
...
const SearchScreen = () => {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyTitle}>{hasQuery ? 'No results found' : 'Search menu items'}</Text>
      <Text style={styles.emptySubtitle}>
        {hasQuery ? 'Try searching something else' : 'Search dishes, cuisines or categories'}
      </Text>
    </View>
  );
      ...
      <View style={styles.container}>
        ...
        <View style={styles.searchWrapper}>
          <View style={[styles.searchBox, isFocused && styles.searchBoxFocused]}>
            <Ionicons name="search" size={18} color={isFocused ? theme.colors.primary : '#999'} />
        ...
        <FlatList
          ...
          contentContainerStyle={[styles.listContent, !hasResults && { flexGrow: 1 }]}
