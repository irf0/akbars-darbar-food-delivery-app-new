...
const DEV_SCREENS: DevScreenEntry[] = [
    ...
    },
    {
        name: 'BadgePreview',
        title: 'Badge',
        description: 'Filled, outlined & ghost across all semantic colors and sizes',
        icon: '◉',
        category: 'Display',
    },
    {
        name: 'AvatarPreview',
        title: 'Avatar',
        description: 'Circle, rounded & square with presence indicators and badge slot',
        icon: '◎',
        category: 'Display',
    },
    {
        name: 'LoaderPreview',
        title: 'Loader',
        description: 'Spinner, dots & pulse across sizes and colors',
        icon: '⟳',
        category: 'Feedback',
    },
    {
        ...
        title: 'Skeleton',
        description: 'Rect, circle & text with real-world loading compositions',
        icon: '▨',
        category: 'Feedback',
    },
    {
        ...
        title: 'Empty State',
        description: 'No results, empty cart, offline & more with action buttons',
        icon: '◻',
        category: 'Feedback',
    },
    {
        name: 'ToastPreview',
        title: 'Toast',
        description: 'Success, error, warning, info & neutral with actions and positions',
        icon: '💬',
        category: 'Feedback',
    },
    {
        name: 'ModalPreview',
        title: 'Modal',
        description: 'Confirm, destructive, info & custom content with size variants',
        icon: '▣',
        category: 'Display',
    },
    // {  //skipping for now since it's doesn't run in Expo Go
    //     name: 'BottomSheetPreview',
    //     title: 'Bottom Sheet',
    //     description: 'Snap points, backdrop, handle, scrollable content & dynamic height',
    //     icon: '⬒',
    //     category: 'Display',
    // },
    {
    ...
    },
    {
        ...
        title: 'List Item',
        description: 'Simple, subtitle, icons, switch, thumbnail, destructive & disabled',
        icon: '☰',
        category: 'Display',
    },
    {
